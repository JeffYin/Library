...
import cgc.library.dao.UserDao;
import cgc.library.model.User;
import cgc.library.service.UserExistsException;
import cgc.library.service.UserManager;
import cgc.library.service.UserService;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "cgc.library.service.UserService")
